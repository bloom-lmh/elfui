...
Speed up same-key list replacement by bypassing keyed diff allocations and DOM movement, and lazily cache larger pure-static macro subtrees for cloning across component renders.
