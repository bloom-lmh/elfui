...
| 场景               | 安装                           | 导入                                               |
| ------------------ | ------------------------------ | -------------------------------------------------- |
| 新项目 / 组件库    | `elfui` + `@elfui/vite-plugin` | `import { defineHtml } from "elfui"`               |
...
| 包                   | 职责                                            |
| -------------------- | ----------------------------------------------- |
| `elfui`              | 宏组件主入口，聚合常用响应式和 runtime API      |
...
```ts
import { getConfig, resetConfig } from "elfui";
