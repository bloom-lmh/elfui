...
import { elfuiMacroPlugin } from "../vite";
...
describe("M9.7 macro runtime coverage", () => {
  it("does not treat removed fragment APIs as macro authoring imports", () => {
    const plugin = elfuiMacroPlugin();
    const result = plugin.transform?.(
      'import { defineFragment, fragment } from "@elfui/core";\nvoid defineFragment;\nvoid fragment;',
      "/workspace/src/removed-fragments.ts"
    );
